...
int main(int argc, char ** av){
    ...
    FILE * d1 = NULL;
    d1 = fopen(av[1], "rt"); if(d1 == NULL) { fprintf(stderr, "Could not open input dictionary (1) file\n"); exit(-1);}  
    FILE * d2 = NULL;
    d2 = fopen(av[2], "rt"); if(d2 == NULL) { fprintf(stderr, "Could not open input dictionary (2) file\n"); exit(-1);}  
    ...
    FILE * hits_dictionary = fopen(av[3], "wt"); if(hits_dictionary == NULL) { fprintf(stderr, "Could not open output hits dictionary file\n"); exit(-1);}
